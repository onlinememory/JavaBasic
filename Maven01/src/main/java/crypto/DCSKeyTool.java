...
//            System.out.println("secureRandom.nextInt() " + secureRandom.nextInt());
...
//        msgToCompare = msgToCompare.toUpperCase();
        String msg = "{AirportCode:" + airport.toUpperCase() + ",Products:" + functions.toUpperCase() + ",TimeLimited:" + date + "}";
